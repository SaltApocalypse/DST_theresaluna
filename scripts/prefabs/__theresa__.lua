...
local function onbecamehuman(inst)
	...
	inst.components.locomotor:SetExternalSpeedMultiplier(inst, "__theresa___speed_mod", 1)
end

local function onbecameghost(inst)
	-- Remove speed modifier when becoming a ghost
	inst.components.locomotor:RemoveExternalSpeedMultiplier(inst, "__theresa___speed_mod")
end
